...
class Order
{
	...
	public static function getLocationsByName($name = "", $count = 10)
	{
		$result = [];
	...
	public static function getUserProfiles($name = '', $count = 10)
	{
		global $USER;
	...
	public static function getOrderProps($order)
	{
	...
	protected static function getDeliveryIds($order)
	{
		$result = [];
	...
	public static function getOrderCalculate($deliveryId = '', $paySystemId = '', $cityCode = '', $personTypeId = 1)
	{
		global $USER;
	...
	public static function orderValidator($order, $props)
	{
		$errors = [];
	...
	public static function makeOrder($deliveryId = '', $paySystemId = '', $props = '', $cityCode = '', $personTypeId = 1, $points = 0)
	{
		global $USER;
		...
		if (!empty($points))
			Points::payOrder($order->getId(), $points);
